...
namespace PeliculasAPI.Servicios
{
    public class CuentasServices : ControllerBase, ICuentasServices
    {
        ...
        public CuentasServices(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IConfiguration configuration,ApplicationDbContext context,IMapper mapper)
        {
        ...
        public async Task<UserToken> ConstruirToken(UserInfo userInfo)
        {
